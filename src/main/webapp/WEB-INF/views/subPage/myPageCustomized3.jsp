...
<html>
	<head>
	<meta charset="UTF-8">
		<title>arTchive / 마이페이지 - 개인정보 수정(맞춤 정보)3</title>
		<link rel="stylesheet" type="text/css" href="<c:url value='/css/reset.css'/>"/>
		<link rel="stylesheet" type="text/css" href="<c:url value='/css/myPageCustomized3.css'/>"/>
		...
		<section>
			...
			<div class="myPageBox">
				...
				<div class="titleBox">
						...
						<a href="<c:url value='/subPage/myPageCustomized3'/>">맞춤 정보</a>
				</div><!-- titleBox -->
