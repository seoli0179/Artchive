...
<html>
	<head>
	<meta charset="UTF-8">
		<title>마이페이지 - 활동 내역</title>
		<link rel="stylesheet" type="text/css" href="<c:url value='/css/reset.css'/>"/>
		<link rel="stylesheet" type="text/css" href="<c:url value='/css/myPageActive.css'/>"/>
	...
	<body>
		...
		<section>
			...
			<div class="myPageBox">
				...
				<div class="myExhbn">
					<div class="titleBox">
						<a href="<c:url value='/subPage/myPageActive'/>">게시글</a>
						<a href="<c:url value='/subPage/myPageComment'/>">댓글</a>
					</div><!-- titleBox -->
