			...
			<div class="myPageBox">
				...
				<p class="line">
					<div class="userBox">
						...
						<div class="buttonBox">
							<a class="ModifyInfo" href="<c:url value='/subPage/myPage/myPageCheck'/>">개인정보 수정</a>
							<a class="withdraw" href="<c:url value='/subPage/myPage/myPageWithdraw'/>">회원탈퇴</a>
						</div> <!-- buttonBox -->
				...
				<div class="myExhbn">
					<h2>내 전시</h2>
					<div class="titleBox">
						<a href="<c:url value='/subPage/myPage/myPageHome'/>">스크랩</a>
						<a href="<c:url value='/subPage/myPage/myPageLike'/>">좋아요</a>
						<a href="<c:url value='/subPage/myPage/myPageCourse'/>">코스</a>
					</div><!-- titleBox -->
