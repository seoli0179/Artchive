				...
				<form>
					<div class="tableBox">
						<div class="centerBox">
							...
							<span>회원 탈퇴시 아래 내용을 먼저 확인해주세요.<br>
							* 회원 탈퇴는 신청하시는<span class="red"> 즉시 처리</span>됩니다.</span><br>
							<span class="caution">로그인이 필요한 서비스 이용은 더 이상 이용하실 수 없게 됩니다. <br>(예 : 이벤트 참여, 게시판 작성 등)</span>
						</div>
