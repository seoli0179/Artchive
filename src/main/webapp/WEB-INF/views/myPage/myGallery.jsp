...
<link rel="stylesheet" type="text/css"
	href="<c:url value='/css/myPage/myGallery.css'/>" />
<script src="https://kit.fontawesome.com/50d21a2bed.js"
	crossorigin="anonymous"></script>
<script src="<c:url value='/tools/jquery-3.6.0.min.js'/>"></script>
<script src="<c:url value='/js/myPage/bookMark.js'/>"></script>
								...
								<tbody>
									<c:choose>
										...
										<c:when test="${empty bookMarkList}">
											<tr>
												<td colspan="3">관심 등록한 전시가 없습니다.</td>
											</tr>
										</c:when>
										...
										<c:otherwise>
											<c:forEach items="${bookMarkList}" var="bookMark"
												...
												<tr>
													<td><a
														href="<c:url value='/exhbn/detail/${bookMark.exhbnId}'/>">${bookMark.exhbnTitle}</a></td>
													<td><fmt:formatDate value="${bookMark.bookmarkAt}"
