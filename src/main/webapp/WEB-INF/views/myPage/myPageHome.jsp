...
<html>
	...
	<meta charset="UTF-8">
		...
		<link rel="stylesheet" type="text/css" href="<c:url value='/css/myPage/myPageHome.css'/>"/>
            ...
            <div class="course-box guide-box">
                ...
                <div class="guide-img-box">
                    <div class="guide-contents">
                        <a class="items" href="<c:url value='/myPage/myPageEdit'/>"> 
                    ...
                    <div class="guide-contents">
                    	<a class="items" href="<c:url value='/myPage/myPagePw'/>"> 
                    ...
                    <div class="guide-contents">
						<a class="items" href="<c:url value='/myPage/myPageScrap'/>"> 
                     ...
                     <div class="guide-contents">
						<a class="items" href="<c:url value='/myPage/myPageAct'/>"> 	
                    ...
                    <div class="guide-contents">
                        <a class="items" href="<c:url value='/myPage/myPageRecmd'/>"> 
                     ...
                     <div class="guide-contents">
						<a class="items" href="<c:url value='/myPage/myPageWithdraw'/>">                      
