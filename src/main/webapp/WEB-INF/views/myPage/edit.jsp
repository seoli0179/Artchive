...
<link rel="stylesheet" type="text/css"
	href="<c:url value='/css/myPage/edit.css'/>" />
				...
				<div class="course-box guide-box">
					<nav>
						<ul class="tabMenu">
							...
							<li><a href="<c:url value='/myPage/reviewScrap'/>"><i class="fa-solid fa-star"></i> 전시 리뷰</a></li>
						...
						<form method="post" id="editFrm" class="editFrm" name="editFrm">
							<div class="tableBox">
								...
								<div class="infoBox">
									...
									<input type="text" id="userId" name="userId" class="idInput"
								...
								<div class="infoBox">
									...
									<input type="button" id="nameBtn"
										class="nameBtn white-btn edit" value="수정">
								</div>
								<!-- infoBox -->
								...
								<div class="nameBox">
									...
									<input type="text" id="userName" name="userName"
										class="nameInput" placeholder="이름 입력" value="${user.userName}">
									<div class="explain">
										<i class="fa-solid fa-circle-info"></i> 이동통신사 및 신용평가기관 모두 변경된
										이름으로 등록되어 있는지 확인 후 진행해주세요.
									</div>
								</div>
						...
						<div class="numberBox">
							...
							<div class="warning">휴대폰번호를 입력해주세요. (-없이 입력)</div>
								...
								<div class="infoBox">
									...
									<input type="button" id="nicknameBtn"
										class="nicknameBtn white-btn edit" value="수정">
								</div>
								<!-- infoBox -->

								<div class="nicknameBox">
									<div class="explain">한글 1~10자, 영문 대소문자 2~20자, 숫자를 사용할 수
										있습니다.(혼용가능)</div>
									<input type="text" id="userNickname" name="userNickname"
										class="nicknameInput" placeholder="닉네임 입력"
								...
								<div class="infoBox">
									...
									<input type="button" id="emailBtn"
										class="emailBtn white-btn edit" value="수정">
								</div>
								<!-- infoBox -->
								...
								<div class="emailBox">
									...
									<input type="text" id="userEmail1" name="userEmail1"
										value="${email1}" class="emailInput" placeholder="변경 이메일">
									<select class="emailAddress" id="userEmail2" name="userEmail2">
										<option value="naver.com"
											<c:if test="${email2 eq 'naver.com'}">selected</c:if>>@naver.com</option>
										<option value="daum.net"
											<c:if test="${email2 eq 'daum.net'}">selected</c:if>>@daum.net</option>
										<option value="nate.com"
											<c:if test="${email2 eq 'nate.com'}">selected</c:if>>@nate.com</option>
										<option value="kakao.com"
											<c:if test="${email2 eq 'kakao.com'}">selected</c:if>>@kakao.com</option>
								...
								<div class="emailNumBox">
									...
									<input type="text" id="userEmailNum" name="userEmailNum"
										class="emailNumInput" placeholder="인증번호 입력">
								</div>
								...
								<div class="infoBox">
									...
									<div class="inputBox">
										<div class="radioStyle">
											<input type="radio" name="userGender" value="M" class="men"
												<c:if test="${user.userGender eq 'M'}">checked</c:if>
												disabled> <label for="men">남</label>

										</div>
										<!-- radioStyle -->

										<div class="woman">
											<input type="radio" name="userGender" value="F" class="women"
												<c:if test="${user.userGender eq 'F'}">checked</c:if>
												disabled> <label for="women">여</label>
										</div>
