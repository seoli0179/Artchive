...
<link rel="stylesheet" type="text/css"
	href="<c:url value='/css/myPage/check2.css'/>" />
						...
						<form>
							<div class="tableBox">
								<div class="centerBox">
									...
									<span>정보를 안전하게 보호하기 위해<br> <span class="red">비밀번호를
											다시 한 번 확인</span>합니다.
									</span><br> <span class="caution">비밀번호가 타인에게 노출되지 않도록 항상
										주의해주세요.</span>
								</div>
								...
								<div class="buttonBox">
									<input type="button" id="submitBtn" class="black-btn"
										value="확인"> <input type="reset" class="white-btn"
										value="취소">
								</div>
								<!-- buttonBox -->
							</div>
