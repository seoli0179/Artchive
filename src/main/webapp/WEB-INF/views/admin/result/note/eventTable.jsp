...
<script src="<c:url value='/js/admin/note/eventDialog.js' />"></script>
    ...
    <table class="resultTable">
        ...
        <c:forEach items="${notes}" var="note" varStatus="status">
            <tr>
                ...
                <td><fmt:formatDate value="${note.eventStartDate}" pattern="yy-MM-dd"></fmt:formatDate> </td>
                <td><fmt:formatDate value="${note.eventEndDate}" pattern="yy-MM-dd"></fmt:formatDate> </td>
