            ...
            <tr class="displayBox" id="displayBox_${idx.index}">
                <td colspan="8">
                    ...
                    <table class="editTable">
                        ...
                        <tr>
                            <th>이메일</th>
                            <td><input id="userEmail_${idx.index}" type="text" value="${user.userEmail}"></td>
                        </tr>
                        <tr>
                            <th>닉네임</th>
                            <td><input id="userNickname_${idx.index}" type="text" value="${user.userNickname}"></td>
                        </tr>
                        <tr>
                            <th>성별</th>
                            <td>${user.userGender}</td>
                        ...
                        <tr>
                            <th>생년월일</th>
                            <td><fmt:formatDate value="${user.userBirth}" pattern="yy-MM-dd hh:mm"/></td>
                        </tr>
                        <tr>
                            <th>유저권한</th>
                            <td>
                                <select id="userRoll_${idx.index}">
                                    <option value="USER" <c:if test="${user.userRoll == 'USER'}">selected</c:if>>유저
                                    </option>
                                    <option value="ADMIN" <c:if test="${user.userRoll == 'ADMIN'}">selected</c:if>>관리자
                                    </option>
                                </select>
                        <tr>
                            <th>생성일</th>
                        ...
                        <tr>
                            <th>수정일</th>
                            <td><fmt:formatDate value="${user.updatedAt}" pattern="yy-MM-dd hh:mm"/></td>
                        </tr>
                        <tr>
                            <th>유저상태</th>
                            <td>
                        ...
                        <tr>
                            <td colspan="2">
                                <button id="saveBtnBox_${idx.index}" class="saveBtn">저장</button>
                            </td>
                        </tr>
                    </table>
                </td>
